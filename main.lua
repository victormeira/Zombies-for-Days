...
Shoe = {
  image = love.graphics.newImage("shoes.png"),
  nomapa = 0,
  equipada = 0,
  numero = 22, --numero que randomiza quando a shotgun spawna
  usagetime = 0,
...
function love.draw()
  ...
  if hero.hp > 0 then
   ...
   --love.graphics.draw(hero.walk[hero.anim_frame], hero.pos_x, hero.pos_y)
    ...
    if Shoe.nomapa == 1 then
      love.graphics.draw(Shoe.image, Shoe.pos_x,Shoe.pos_y)
    end
